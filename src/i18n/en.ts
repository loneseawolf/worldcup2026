...
const en: Dict = {
  ...
  probPreMatch: 'Pre-match',
  // ---- shared live match sections (commentary / team stats / ratings) ----
  commentaryTitle: 'Commentary',
  commentaryFallback: 'Live commentary unavailable — showing key events.',
  teamStatsTitle: 'Team stats',
  teamStatsSource: 'Match statistics via ESPN.',
  ratingsNote: 'Player ratings are a derived estimate, not official.',
  tsPossession: 'Possession',
  tsShots: 'Shots',
  tsShotsOnTarget: 'Shots on target',
  tsCorners: 'Corners',
  tsFouls: 'Fouls',
  tsAccuratePasses: 'Accurate passes',
  tsPassPct: 'Pass accuracy',
  // ---- tournament forecast ----
  navSim: 'Forecast',
  ...
  liveGoal: 'Goal',
  liveOwnGoal: 'Own goal',
  livePen: 'Penalty',
  liveYellow: 'Yellow card',
  liveRed: 'Red card',
  liveSubOnOff: 'Substitution',
  // watch
