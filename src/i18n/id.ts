...
const id: Dict = {
  ...
  allTeams: 'Semua tim',
  allStages: 'Semua babak',
  allVenues: 'Semua stadion',
  filters: 'Filter',
  colon: ': ',
  filterStageSel: '1 Babak',
  filterVenueSel: '1 Stadion',
  filterTeamsSel: '{n} Tim',
  ...
  fcFav: 'Favorit',
  fcSeed: 'Peringkat grup',
  fcElim: 'Tersingkir di',
  fcTop4: 'Empat besar',
  fcGrpExit: 'Grup',
  fcGrpExitTip: 'Tersingkir di fase grup',
  fcPos1: 'Ke-1',
  fcPos2: 'Ke-2',
  fcPos3: 'Ke-3',
  fcPos4: 'Ke-4',
  fcPctNote: 'Semua nilai dalam persen (%). Ketuk judul kolom untuk mengurutkan.',
